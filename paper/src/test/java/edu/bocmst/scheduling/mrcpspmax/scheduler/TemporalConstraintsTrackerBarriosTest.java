...
public class TemporalConstraintsTrackerBarriosTest {
	...
	public void testBoundInitializationCorrect() throws Exception {
		IModeAssignment candidate = ModeAssignment.createInstance(MODES, TestConstants.THESIS_INSTANCE);
...
//		assertEquals(new StartTimeWindow(9, 9), testee.getStartTimeWindow(7));
		...
		assertEquals(new StartTimeWindow(0, Integer.MAX_VALUE), testee.getStartTimeWindow(0));
		assertEquals(new StartTimeWindow(0, Integer.MAX_VALUE), testee.getStartTimeWindow(1));
		assertEquals(new StartTimeWindow(0, Integer.MAX_VALUE), testee.getStartTimeWindow(2));
		assertEquals(new StartTimeWindow(1, Integer.MAX_VALUE), testee.getStartTimeWindow(3));
		assertEquals(new StartTimeWindow(4, Integer.MAX_VALUE), testee.getStartTimeWindow(4));
		assertEquals(new StartTimeWindow(5, Integer.MAX_VALUE), testee.getStartTimeWindow(5));
		assertEquals(new StartTimeWindow(5, Integer.MAX_VALUE), testee.getStartTimeWindow(6));
		assertEquals(new StartTimeWindow(9, Integer.MAX_VALUE), testee.getStartTimeWindow(7));
	}
	...
	public void testBarriosReschedulingExample() throws Exception {
		...
		testee.schedule(1, 0);
		testee.schedule(3, 6);
		assertEquals(new StartTimeWindow(10, 10), testee.getStartTimeWindow(5));
		testee.schedule(2, 6);
		assertEquals(new StartTimeWindow(10, 10), testee.getStartTimeWindow(4));
