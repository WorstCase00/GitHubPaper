package edu.bocmst.scheduling.mrcpspmax.ga.mutation;
...
public class ModeAssignmentMutationWrapper implements
		EvolutionaryOperator<IMrcpspMaxCandidate> {

		private static final Logger LOGGER = LoggerFactory.getLogger(ModeAssignmentMutationWrapper.class);
		private RandomModeMutation mutation;

	public ModeAssignmentMutationWrapper(RandomModeMutation randomModeMutation) {
		this.mutation = randomModeMutation;
	}
	...
	public List<IMrcpspMaxCandidate> apply(
		...
		List<IModeAssignment> repairedModeAssignments = mutation.apply(modeAssignments, rng);
